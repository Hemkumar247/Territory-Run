...
export interface FABButtonProps extends HTMLMotionProps<"button"> {
  ...
  /** When true the button renders a subtle breathing animation (idle/play state) */
  breathe?: boolean;
}

export const FABButton = React.forwardRef<HTMLButtonElement, FABButtonProps>(
  ({ className, icon, label, variant = 'primary', breathe = false, children, ...props }, ref) => {
    return (
      <motion.button
        ref={ref}
        ...
        className={cn(
          ...
          breathe
            ? 'animate-fab-breathe-light dark:animate-fab-breathe'
            : 'shadow-[0_0_24px_rgba(0,139,153,0.2),0_4px_16px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.4)] dark:shadow-[0_0_24px_rgba(0,229,255,0.2),0_4px_16px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.15)]',
          className
        )}
        {...props}
      >
